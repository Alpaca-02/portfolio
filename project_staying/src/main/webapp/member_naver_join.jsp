...
<body>
    ...
    <div id="wrapper">
        ...
        <header>
            <h1 class="logo">
                <a href="index.html">
                    <img src="${contextPath}/images/logocap.png" alt="페이지 로고">
                </a>
            </h1>
            <nav role="navigation">
            ...
            <section id="member_join_area">
                ...
                <form action="${contextPath}/member/addMember.do" method="post" id="frm_join" name="frm_join">
                    <div class="frm_input_area">
                        <p>
                            <label for="name">이름</label><input type="text" id="name" name="name" value="${memberVO.getName() }"  readonly placeholder="이름" style="width: 44%;">
                        </p>
                        <p>
                            <label for="id">아이디</label><input type="text" id="id" name="id" value="${memberVO.getId() }" readonly placeholder="아이디" style="width: 44%;">
                        </p>
                        <p>
                            <input type="pwd" name="pwd" id="pwd" placeholder="영문/숫자 8~20 비밀번호">
                        </p>
                        <p>
                        ...
                        <p class="pwd_check"></p>
                        <p>
                            <input type="tel" class="input_phone" name="phone" id="phone" maxlength="11" title="하이픈(-)은 입력할 수 없습니다" placeholder="전화번호 숫자만 입력">
                            <input type="button" class="btn_send_code" value="인증번호 발송" onclick="ck_ph()">
                        </p>
                        <p>
                            <input type="number" name="input_check_code" class="input_check_code" maxlength="6" placeholder="인증번호 입력">
                            <input type="button" class="btn_check_code" value="인증번호 확인" onclick="ck_num()">
                        </p>
                    ...
                    <div class="btn_join_area">
                        <input type="button" name="btn_join" class="btn_join" value="회원가입">
                    </div>
                </form>
            </section>
        </div>
        <footer>
            <div id="footer_inner">
                <div class="page_info_area">
                    <img src="${contextPath}/images/rm_back_logo.png" alt="페이지 로고">
                    <p class="page_info"> 
